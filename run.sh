...
py main.py --dataset ogbg-molhiv --hidden_channels 64 --batch_size 256 --local_epochs 100 --global_epochs 100 --lr 0.001 --runs 1 --local_layers 7 --global_layers 2 --weight_decay 0.00001 --dropout 0.3 --in_dropout 0.2 --device 0 --num_heads 8 --use_edges 0 --save_model 